                        ...
                        if ( !empty(NumRows_stats) ) {
                            ...
                            if ($_POST['sum_payout'] <= $assoc_users_data['balance_withdrawal']) {
                                ...
                                if ( empty($numrows) ) {
                                    ...
                                    if ($as_money_payin['sum_payin'] >= 50) {    //активация выплат
                                        /*if ($assoc_users_data['bullet'] < $_POST['sum_payout']) {
                                            MessageSend('Недостаточно платежных баллов '.$assoc_users_data['bullet'].' ед.', '/pay/payout_money');
                                        }*/

                                        $db->Query("UPDATE `users_data` SET `balance_withdrawal` = (`balance_withdrawal` - '$_POST[sum_payout]'), `bullet` = (`bullet` - '$_POST[sum_payout]') WHERE `uid` = '$_SESSION[id]'");
                                        ...
                                        MessageSend('Для активации выплат необходимо пополнить баланс для покупок на 50 руб.', '/pay/payout_money');
                                    }
                                }
                                else {
