...
?>
<?php
top_auth('Рекламный баланс', '/auth/pay/style/payin_admoneystyle', false, 'payin_money');
?>
    		...
    		<div class="strokeblock1_cp">
                <div class="container1_sb1cp">
                    <p class="text_container1_sb1cp">
                        Здесь можно пополнить свой собственный рекламный баланс. 
                        Рекламный баланс необходим для рекламодателей которые оплачивают 
                        размещение своих рекламных площадок в специализированных разделах 
                        проекта, например в разделе «Сёрфинг сайтов». <b>Если Вы хотели пополнить 
                        свой баланс для покупок перейдите в <a href="/pay/payin_money">соответствующий раздел</a></b>.
                    </p>
                </div>
                <div class="container2_sb1cp">
                    <p>Вам необходима качественная реклама?</p>
                    <a href="/addsurf">
